...
(function($) {
		...
		function set_preview_google_search_result() {
			...
			var page_url_basehref = $('input[name="URLSegment"]').attr('data-prefix'),
				...
				page_title       = $('#Form_ItemEditForm_Title').val(),
				page_metadata_title = $('#Form_ItemEditForm_MetaTitle').val().length > 0 ? $('#Form_ItemEditForm_MetaTitle').val() : page_title,
				page_metadata_description = $('#Form_ItemEditForm_MetaDescription').val(),
